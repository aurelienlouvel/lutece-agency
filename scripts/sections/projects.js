...
// body element
const body = document.querySelector(".projects .tracking__projects");
// helper functions
const MathUtils = {
...
const getMousePos = (ev) => {
    ...
    if (ev.pageX || ev.pageY) {
        posx = ev.pageX;
        posy = ev.pageY - document.querySelector(".projects").offsetTop;
    }
...
class ImageTrail {
    constructor() {
        // images container
        this.DOM = { content: document.querySelector(".projects") };
    ...
    render() {
        ...
        //  else if (distance > this.threshold && this.imgPosition >= this.imagesTotal - 1) {
        //     this.imgPosition = 0;
        //  }
...
const preloadImages = () => {
    return new Promise((resolve, reject) => {
        imagesLoaded(document.querySelectorAll(".projects__img"), resolve);
    });
};
